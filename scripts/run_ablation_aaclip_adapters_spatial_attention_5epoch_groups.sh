...
echo "Running AA-CLIP style adapter group ablation"
echo "Device: ${DEVICE}"
echo "Epochs: ${EPOCHS}"
...
group_names = ["adapter_1_3", "adapter_1_6", "adapter_1_9", "adapter_3_6_9_12"]
summary_path = out_root / "aaclip_adapter_group_metrics_summary.csv"
fields = [
    "group",
    "adapter_type",
    "adapter_layers",
...
for group_name in group_names:
    ...
    row = {"group": group_name, "adapter_type": "aaclip"}
...
echo
echo "AA-CLIP style adapter group ablation completed."
echo "Aggregate summary: ${OUT_ROOT}/aaclip_adapter_group_metrics_summary.csv"
