...
BACKBONE_NAME="${BACKBONE_NAME:-vit_h}"
OUT_DIR="${OUT_DIR:-experiments/residual-adapters-refined-mask/mydatasets/sam-vit-h}"
RESULT_DIR="${RESULT_DIR:-${OUT_DIR}/results}"

echo "Running ProtoWD on mydatasets with SAM ViT-H"
echo "Device: ${DEVICE}"
echo "Epochs: ${EPOCHS}"
