...
LAYERS="${LAYERS:-2 4 6 8 10 12}"
SUMMARY_NAME="${SUMMARY_NAME:-single_layer_metrics_summary_gpu0.csv}"

echo "Running DINOv3 ViT-L single-layer spatial-attention ablation"
echo "Part: shallow/middle layers"
echo "Device: ${DEVICE}"
echo "Layers: ${LAYERS}"
echo "Epochs: ${EPOCHS}"
