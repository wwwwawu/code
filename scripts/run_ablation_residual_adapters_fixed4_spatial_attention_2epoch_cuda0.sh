...
OUT_ROOT="${OUT_ROOT:-ablation/residual-adapters-fixed4-spatial-attention-2epoch}"
...
echo "Running fixed-4 residual-adapter position ablation"
echo "Device: ${DEVICE}"
echo "Epochs: ${EPOCHS}"
...
echo "Residual adapters: enabled, fixed 4 layers per group"
...
group_names = ["adapter_9_12", "adapter_13_16", "adapter_18_24_30_32"]
adapter_layers = {
    "adapter_9_12": "9,10,11,12",
    "adapter_13_16": "13,14,15,16",
    "adapter_18_24_30_32": "18,24,30,32",
}
summary_path = out_root / "fixed4_residual_adapter_position_metrics_summary.csv"
fields = [
    "group",
    "adapter_layers",
    "precision",
...
for group_name in group_names:
    ...
    row = {"group": group_name, "adapter_layers": adapter_layers[group_name]}
...
echo
echo "Fixed-4 residual-adapter position ablation completed."
echo "Aggregate summary: ${OUT_ROOT}/fixed4_residual_adapter_position_metrics_summary.csv"
