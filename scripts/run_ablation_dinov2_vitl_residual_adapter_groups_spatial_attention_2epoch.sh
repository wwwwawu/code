...
OUT_ROOT="${OUT_ROOT:-ablation-vitl/resiual-adapters-spatial-attention/image756}"
FEATURES="${FEATURES:-12 16 20 24}"
SUMMARY_NAME="${SUMMARY_NAME:-adapter_group_metrics_summary.csv}"
...
echo "Running DINOv2 ViT-L residual-adapter group ablation"
...
echo
echo "Completed DINOv2 ViT-L residual-adapter group ablation."
