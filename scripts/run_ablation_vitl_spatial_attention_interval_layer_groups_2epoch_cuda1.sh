...
SUMMARY_NAME="${SUMMARY_NAME:-interval_layer_group_metrics_summary.csv}"

echo "Running DINOv3 ViT-L interval-layer spatial-attention group ablation"
echo "Device: ${DEVICE}"
echo "Epochs: ${EPOCHS}"
...
echo
echo "Interval-layer group ablation completed."
