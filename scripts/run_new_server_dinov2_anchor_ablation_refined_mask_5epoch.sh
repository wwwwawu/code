...
OUT_ROOT="${OUT_ROOT:-ablation-vitl/resiual-adapters-spatial-attention-refined-mask-5epoch/image756/anchor_ablation}"
SUMMARY_NAME="${SUMMARY_NAME:-anchor_metrics_summary.csv}"

ANCHORS=(2 4 8 16)
GROUP_NAMES=()

echo "Running new-server DINOv2 ViT-L anchor ablation"
echo "Device: ${DEVICE}"
...
echo
echo "Completed DINOv2 ViT-L anchor ablation."
