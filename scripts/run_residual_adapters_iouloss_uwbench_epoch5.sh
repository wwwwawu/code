...
ROOT="experiments/residual-adapters-iouloss/uwbench-epoch${EPOCHS}"

echo "Running residual-adapter + IoU-loss UW-Bench experiments"
echo "Device: ${DEVICE}"
echo "Epochs: ${EPOCHS}"
...
echo "All residual-adapter + IoU-loss runs completed."
