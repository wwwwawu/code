...
def parse_args():
    parser = argparse.ArgumentParser("Test U2Net baseline for road waterlogging segmentation")
    ...
    parser.add_argument("--checkpoint_path", type=str, default="experiments/u2net/checkpoints/epoch_50.pth")
    parser.add_argument("--save_path", type=str, default="experiments/u2net/results")
    parser.add_argument("--image_size", type=int, default=0, help="0 means use checkpoint config")
    parser.add_argument("--model_type", type=str, default="", choices=["", "u2net", "u2netp"])
