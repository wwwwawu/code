...
from train import DEFAULT_UWBENCH_META, DEFAULT_UWBENCH_ROOT, UNet, build_transforms, setup_seed
...
def parse_args():
    parser = argparse.ArgumentParser("Test U-Net baseline for road waterlogging segmentation")
    ...
    parser.add_argument("--checkpoint_path", type=str, default="experiments/unet/checkpoints/epoch_50.pth")
    parser.add_argument("--save_path", type=str, default="experiments/unet/results")
    parser.add_argument("--image_size", type=int, default=0, help="0 means use checkpoint config")
    parser.add_argument("--base_channels", type=int, default=0, help="0 means use checkpoint config")
