...
def parse_args():
    parser = argparse.ArgumentParser("Test SETR-PUP baseline for road waterlogging segmentation")
    ...
    parser.add_argument("--checkpoint_path", type=str, default="experiments/setr_vit_b16/checkpoints/epoch_50.pth")
    parser.add_argument("--save_path", type=str, default="experiments/setr_vit_b16/results")
    parser.add_argument("--image_size", type=int, default=0, help="0 means use checkpoint config")
    parser.add_argument("--backbone", type=str, default="", choices=[""] + sorted(MODEL_IDS.keys()))
    ...
    parser.add_argument("--decoder_dim", type=int, default=0, help="0 means use checkpoint config")
